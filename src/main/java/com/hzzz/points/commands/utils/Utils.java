...
public class Utils {
    public static Component builder_player_coordinates_message(String config_root, FileConfiguration config, Player player){
        ...
        if (config.getBoolean(String.format("%s.teleport-support",config_root), false)) {
            component = component.append(Component.text("[tp] ").color(NamedTextColor.RED)
