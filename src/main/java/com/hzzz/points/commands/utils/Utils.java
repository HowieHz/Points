...
public final class Utils {
    public static Component builderPlayerCoordinatesMessage(String config_root, FileConfiguration config, Player player, String separator, NamedTextColor separator_color) {
